...
const MESSAGES = {
  ...
  freezeHeader: { en: "Freeze panes", ko: "틀 고정" },
  ...
  groupInsert: { en: "Insert", ko: "삽입" },
  groupFont: { en: "Font", ko: "글꼴" },
  groupAlign: { en: "Alignment", ko: "맞춤" },
  groupNumber: { en: "Number", ko: "표시 형식" },
  groupEdit: { en: "Editing", ko: "편집" },
  groupView: { en: "View", ko: "보기" },
  boldGlyph: { en: "B", ko: "가" },
  textGlyph: { en: "A", ko: "가" },
  autoSum: { en: "Σ AutoSum", ko: "Σ 자동 합계" },
