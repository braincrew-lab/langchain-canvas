...
SYSTEM_PROMPT = (
    ...
    "one-line description, and the revision from read_page. Never rebuild a file "
    "for a small change.\n\n"
    ...
    "with read_page + edit_page (pass the file as `path`) and re-check until it "
    "reports 0 errors.\n"
    ...
    "To change an existing slide later: read_page(path=file) then edit_page with "
